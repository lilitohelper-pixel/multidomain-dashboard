...
export default function AddExpenseForm({ categoryOptions, workspaces, onAdd }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-stone-parchment rounded-lg border p-4 flex flex-wrap items-end gap-3 mb-4">
      <div className="flex-1 min-w-[8rem]">
        <label className="block text-sm text-stone-taupe mb-1">Description</label>
        <input
          type="text"
          value={description}
      ...
      <div className="min-w-[9rem]">
        <label className="block text-sm text-stone-taupe mb-1">Category</label>
        <select
          value={categoryId}
      ...
      <div>
        <label className="block text-sm text-stone-taupe mb-1">Date</label>
        <input
          type="date"
          value={date}
      ...
      <div className="w-24">
        <label className="block text-sm text-stone-taupe mb-1">Amount</label>
        <input
          type="number"
          step="0.01"
          value={amount}
      ...
      <div className="w-20">
        <label className="block text-sm text-stone-taupe mb-1">Currency</label>
        <input
          type="text"
          value={currency}
      ...
      {errorMsg && <p className="text-sm text-amber-rust w-full">{errorMsg}</p>}
    </form>
  );
}
